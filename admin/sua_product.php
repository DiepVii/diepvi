                    ...
                    <div class='infor'>
                        <h3>Sửa Thông Tin Sản Phẩm </h3>   
                            <form action="index.php" enctype='multipart/form-data' method='post' >
                               <?php
                                        echo("<input type='text' readonly required name='mshh'  class='login'  placeholder='Mã Số Sản Phẩm' value='".$_GET['mshh']."'>");
                               ?> 
                                <br>
                               ...
                               <?php
                                ...
                                <input type='submit' value='Cập Nhật Hàng Hóa' name='submit_sua' id='submit'>
                            </form>
