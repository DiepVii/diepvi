...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
       ...
       <link rel="icon" href="../img/detail.png" type="image/x-icon">
...
<body>
    ...
    <div class="div1">
        ...
        <?php
                ...
                $sql="select soluonghang,tenhh,hinhanh,gia,quycach from hanghoa where mshh= \"".$_GET["mshh"]."\"";
                $result=mysqli_query($conn, $sql);
                $product=mysqli_fetch_assoc($result);
                $temp=number_format($product["gia"],0,',','.');
           echo("  <div class=\"detail\">
                        <div class=\"img\">
                                <img src='../img/".$product["hinhanh"]."'>
                        </div>
                        <div class=\"inf\">
                                <form action='thanhtoan.php?mshh=".$_GET['mshh']. "' method='post'>
                                    <ul>
                                        <li><h2 style=\"color: #695e5e;\">".$product["tenhh"]."</h2></li>
                                        <li><a href=\"index.php\">Trang Chủ</a> > ".$product["tenhh"]."</li>
                                        <li> Giá: <span>".$temp." đ</span></li>
                                        <li> Hàng sẵn có: <span>".$product['soluonghang']."</span></li>
                                        <li>
                                            <div class=\"thanhtoan\">
                                                <hr>
                                                <p>Số lượng: <input type=\"number\" max=".$product['soluonghang']." value=1 min=0 name=\"soluong\" required  id=\"soluong\"></p> 
                                                <hr>
                                            </div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <div class=\"thanhtoan\">
                                                <hr>
                                                    <div class=\"pay\">
                                                        <input type=\"submit\" name=\"thanhtoan\" value=\"Thanh Toán\" id=\"thanhtoan\"></p> 
                                                    </div>
                                                <hr>
                                            </div>
                                        </li>
                                        <li>
                                            <div class=\"vanchuyen\">
                                                    <p>Vận chuyển: </p>
                                                    <p>MIỄN PHÍ VẬN CHUYỂN và nhận giao hoa trong ngày khi đặt hàng trước 17h mỗi ngày cho mọi đơn hàng trên địa bàn nội thành Hà Nội và TP.HCM.</p>
                                                    <p>
                                                        *Do mỗi sản phẩm đều được làm thủ công nên sẽ có chút khác biệt so với hình ảnh sẵn có trên website.
                                                    </p>
