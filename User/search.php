...
<div id="id1">
    ...
    <div class="div3">
        <div class="div5">
            ...
            <ul>
                <li class="div4"><a href="index.php#HopHoa">Hoa</a> </li>
                <li class="div4"><a href="index.php#Combo">Combo</a> </li>
                <li class="div4"><a href="index.php#qualuuniem">Quà lưu niệm</a> </li>
                <li class="div4"><a href="index.php#KeHoa">Kệ hoa</a></li>
                <li class="div4"><a href="index.php#CayDeBan">Cây Để Bàn</a></li>
            </ul>
        </div>
    ...
    <div class="qua" id="qualuuniem">
            <h3 style="color: rgb(214, 51, 51);">Kết Quả Tìm Được
                <hr>
            </h3>
            ...
            <?php
                if(isset($_POST['submit'])){
                    $search=$_POST['search']; 
                    $sql="select mshh,TenHH,Gia,hinhanh from hanghoa where tenhh like'%$search%' or quycach like'%$search%'";
